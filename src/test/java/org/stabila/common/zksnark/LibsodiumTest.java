...
public class LibsodiumTest {
	...
	public static byte[] ZSTABILA_EXPANDSEED_PERSONALIZATION = {'Z', 's', 't', 'a', 'b', 'i', 'l', 'a', '_', 'E', 'x',
			'p', 'a', 'n', 'd', 'S', 'e', 'e', 'd'};
	...
	public void testCryptoGenerichashBlake2BInitSaltPersonal(){
		...
		Assert.assertArrayEquals(HexBin.decode("0A8F8E123AC94494CA3A61B05F1693DB5B9F446D9E16C5851359EC8E6657C1BADE1ACDBE1EC0FB7A3A19FEC98988BB27AACC0DA8F96897DA88B3B5E95AED09CD"),
				ask);
	}
	...
	public void testCryptoGenerichashBlake2BUpdate (){
		...
		Assert.assertArrayEquals(HexBin.decode("6721363825AA1C053FD04A8CDF1265C9789F4D069548D1F260CE7900F597A130D393B63EFB033EC9E4021B560141C718A5C528E21D4FE5B94C98CF80CDD5AA4B"),
				nsk);
	}
	...
	public void testCryptoGenerichashBlake2BFinal(){
		...
		Assert.assertArrayEquals(HexBin.decode("AB00556D9F171B5AF691CAE9FF76E46DE8E375916DC271FE868E1B1983CC3DC65B291F2F1A8B3BEB0BB92F5070484CB519271E72C441E7CFEC00C808F62E3152"),
				ovk);
	}
	...
	public void testCryptoGenerichashBlake2BSaltPersonal(){
		...
		Assert.assertArrayEquals(HexBin.decode("F2D148F00DA44965A6218A408155B3777CB9A33B9D51D441E63672ACB965ADB3"),
				ock);
	}
